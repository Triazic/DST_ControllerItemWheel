...
-- -- local onClick_function = function() print("CLICK") end
-- -- newButton.image:SetScale(50, 50)
-- -- newButton.image:SetPosition(0, 0, 0)
-- -- newButton:SetOnClick(onClick_function)
-- -- newButton:Show()
-- -- newButton:SetText("My Balls")
-- -- newButton:Enable()
